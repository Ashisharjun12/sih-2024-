                  ...
                  <div
                    className={cn(
                      ...
                      message.sender._id === params.id
                        ...
                        : "bg-purple-600 text-white rounded-tr-none" // Changed to purple for mentor theme
                    )}
                  >
          ...
          <div className="p-4 bg-background border-t max-md:mb-[49px]">
            <form onSubmit={handleSendMessage} className="flex items-center gap-2 max-w-3xl mx-auto">
              ...
              <Button 
                type="submit" 
                size="icon"
                className="bg-purple-600 hover:bg-purple-700 rounded-full shrink-0" // Changed to purple for mentor theme
              >
