...
import { Send, Search, Briefcase, Beaker, Building2, MessageCircle, UserCircle2, Bell, MoreVertical, Smile, PaperclipIcon, Image as ImageIcon, ArrowLeft } from "lucide-react";
import {
  Tabs,
  TabsContent,
  TabsList,
  ...
  return (
    <div className="container py-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <Card className="p-4">
            <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid grid-cols-4 mb-4">
                ...
                <TabsTrigger value="researcher" className="text-xs">Research</TabsTrigger>
        ...
        {/* Chat Area - Hidden on mobile when users list is open */}
        <div className={`
          lg:col-span-8
          ${!selectedUser || isMobileUsersOpen ? 'hidden lg:block' : 'block'}
        `}>
              ...
              <div className="flex-1 flex items-center justify-center p-4">
                <div className="text-center space-y-3 max-w-md mx-auto">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Connect with startups, researchers, and funding agencies. Select a user from the right to start chatting.
                  </p>
                </div>
              </div>
            )}
