...
export default function ResearcherChatPage({ params }: { params: { id: string } }) {
                  ...
                  <div
                    className={cn(
                      ...
                      message.sender._id === params.id
                        ...
                        : "bg-green-600 text-white rounded-tr-none" // Changed to green for researcher theme
                    )}
                  >
          ...
          <div className="p-4 bg-background border-t max-md:mb-[49px]">
            <form onSubmit={handleSendMessage} className="flex items-center gap-2 max-w-3xl mx-auto">
              ...
              <Button 
                type="submit" 
                size="icon"
                className="bg-green-600 hover:bg-green-700 rounded-full shrink-0" // Changed to green for researcher theme
              >
