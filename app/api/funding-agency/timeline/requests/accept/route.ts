...
export async function POST(req: NextRequest) {
    try {
        ...
        fundingAgency.timeline.isAccepted = "accepted";  // Set the timeline as accepted
        fundingAgency.timeline.preSeedFunding.isActive = "active"; // Set Pre-Seed Funding to active
